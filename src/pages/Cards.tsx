...
interface Card {
  ...
  cardHolder: string;
  expiryDate: string;
  cardType: "visa" | "mastercard" | "amex" | "axis" | "ch17";
  isDefault: boolean;
}
...
const cardSchema = z.object({
  ...
  cardType: z.enum(["visa", "mastercard", "amex", "axis", "ch17"]),
});
...
const initialCards: Card[] = [
  ...
  {
    id: "ch17-1",
    cardNumber: "5412345678902222",
    cardHolder: "CH17 PRIVILEGE",
    expiryDate: "08/28",
    cardType: "ch17",
    isDefault: false,
  },
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent className="glass border-border/50">
                      <SelectItem value="axis">HNBA Loyalty Card</SelectItem>
                      <SelectItem value="ch17">CH17 Card</SelectItem>
